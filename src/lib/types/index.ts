...
export type ExecutionAction =
	...
	| { action: 'toggle_checkbox'; step_heading: string; text: string; checked: boolean }
	| {
			action: 'record_input';
			step_heading: string;
			label: string;
	...
	| { action: 'add_step'; heading: string; description?: string; after_step?: string }
	| { action: 'record_deviation'; description: string; justification: string }
	| { action: 'add_attachment'; filename: string; path: string; content_type: string }
